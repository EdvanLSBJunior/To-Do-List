...
function mostraTarefas() {
    ...
    for (item of tarefas) {
        ...
        itemList.setAttribute('class', 'mdl-list__item-secondary-action','mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect','mdl-checkbox__input') //Espaçamento entre os itens da lista
